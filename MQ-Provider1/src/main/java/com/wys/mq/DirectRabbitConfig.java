...
public class DirectRabbitConfig {
    ...
    @Bean
    Queue productDirectQuene() {
        return new Queue("productDirectQuene", true);
    }
    @Bean
    ...
    Binding bindingProduct() {
        return BindingBuilder.bind(productDirectQuene()).to(productDirectExchange()).with("productRouting");
    }
}
